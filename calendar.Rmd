...
*Letture per la settimana successiva:*  
 ...
 - DSpP appendice: linguaggio $\textsf{R}$. In parallelo, suggerisco anche di consultare il testo [R for Data Science](https://r4ds.had.co.nz/index.html) (i capitoli 22--25 possono essere trascurati).
...
- Vari tutorial sull'uso di $\R$ sono forniti nella pagina [RStudio Educational](https://education.rstudio.com/learn/beginner/).
