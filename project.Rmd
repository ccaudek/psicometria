...
Il repository [ds4psy_R_demos](https://github.com/ccaudek/ds4psy_R_demos) contiene vari script Rmd che illustrano o estendono i temi discussi nella dispensa _Data science per psicologi_.

Si noti che non è possibile visualizzare su GitHub i file html. Per cui vi consiglio di scaricare tutta questa cartella sul vostro computer. Una volta presenti sul vostro computer, i file html possono essere visualizzati.

Nel corso del semestre verranno aggiunti nuovi tutorial. Tutti i tutorial che userò a lezione saranno disponibili in questo repository. 
