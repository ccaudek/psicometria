...
Nel tutorial ho anche inserito il codice per risolvere un esercizio WarmUp usando Colabo, con l'uso di `cmdstan`. Una complicazione è che, per me, è stato più semplice installare `cmdstanpy`, ovvero la versione di `cmdstan` che fa uso dell'interfaccia Python.  Ciò significa che le istruzioni che trovate sulla dispensa e nei demo non funzionano pari pari.  Vanno modificate con le corrispondenti istruzioni Python. Nel tutorial trovate quasi tutto quello che vi serve sapere.
