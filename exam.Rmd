...
Per lo svolgimento dei problemi assegnati all'esame, inoltre, **è richiesta un'installazione funzionante di CmdStan** sul proprio computer; in alternativa (che fortemente consiglio), gli studenti devono essere in grado di utilizzare CmdStan su Colab (come spiegato nei tutorial forniti nel materiale didattico). 
