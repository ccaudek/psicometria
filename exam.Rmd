...
L'esame richiederà la conoscenza di $\textsf{R}$ (o Python, se preferite). L'esame sarà a _libri aperti_, nel senso che gli studenti potranno utilizzare qualsiasi ausilio (elettronico o cartaceo) ritengano utile per trovare la soluzione dei problemi che verranno loro assegnati. L'unico vincolo è che lo studente dovrà lavorare in autonomia senza collaborare in nessun modo con altri. 
<!-- Pratiche disoneste verranno punite seguendo le indicazioni fornite dall'Ateneo. -->
...
L'esame che si svolgerà nel periodo previsto per le sessioni d'esame avrà la forma di un quiz Moodle e conterrà una serie di problemi simili a ai WarmUp forniti nella pagina Moodle dell'insegnamento. 

Per partecipare all'esame è richiesto l'uso del proprio computer portatile. Gli esami si svolgeranno **in presenza** (su disposizione Ministeriale e dell'Ateneo), per cui gli studenti _dovranno portare con sé un computer portatile alla Torretta_ -- altrimenti non potranno partecipare all'esame.

Per lo svolgimento dei problemi assegnati all'esame, inoltre, **è richiesta un'installazione funzionante di CmdStan** sul proprio computer; in alternativa (che fortemente consiglio), gli studenti devono essere in grado di utilizzare CmdStan su Colab (come spiegato nei tutorial forniti nel materiale didattico). Agli studenti che non dispongono di CmdStan sul proprio computer viene dunque richiesto di creare un account Colab **prima** di venire all'esame.
